...
- P0: mutation authorization, safe mutation execution, deterministic non-interactive behavior, removal of unsafe legacy session compatibility, and dependency/install reproducibility.
