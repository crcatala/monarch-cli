...
EXPECTED_INVENTORY: dict[str, frozenset[Effect]] = {
    ...
    "transactions create": frozenset({Effect.REMOTE_MUTATION}),
    "transactions delete": frozenset({Effect.REMOTE_MUTATION}),
    ...
    "transactions review mark": frozenset({Effect.REMOTE_MUTATION}),
    "transactions review return": frozenset({Effect.REMOTE_MUTATION}),
